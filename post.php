                        ...
                        <div class="card-body">
                            ...
                            $data = mysqli_query($conn, "SELECT posts.*, kategori.judul AS nama_kategori, petugas.username AS nama_petugas FROM posts JOIN kategori ON posts.kategori_id = kategori.id JOIN petugas ON posts.petugas_id = petugas.id");
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                    <a href="hapus_post.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-md mr-3" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"><H8>Hapus</H8></a>

                                    <a href="edit_post.php?id=<?php echo $d['id']; ?>" class="btn btn-warning btn-md mr-3"><H8>Edit</H8></a>
                                    
                                    <a href="#" class="btn btn-primary btn-md mr-3" data-toggle="modal" data-target="#modalView<?php echo $d['id'];?>"><h8 class="fa fa-info" aria-hidden="true">post</h8>
                                </a>
                            <!-- Modal detail post-->
