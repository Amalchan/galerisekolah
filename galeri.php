    ...
    <div class="card-body">
		...
		$data = mysqli_query($conn, "SELECT galery.*, posts.judul AS nama_posts FROM galery JOIN posts ON galery.post_id = posts.id");
            ...
            <tr>
                ...
                <td class="d-flex">
                <a href="hapus_galeri.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-md mr-3" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"><i class="fas fa-trash">Hapus</i></a>
